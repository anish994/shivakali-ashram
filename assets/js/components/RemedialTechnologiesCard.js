/**
 * 🛠️ Remedial Technologies Card - Cosmic Debugging & Optimization
 * 
 * A clean card component for Remedial Technologies subcategory.
 * Covers gemstones, mantras, yantras, and ritual protocols.
 */

class RemedialTechnologiesCard {
    constructor() {
        this.subCategory = {
            ...
            practicalApplications: [
                ...
                "Health enhancement protocols",
                "Wealth manifestation techniques"
            ],
            keyTopics: [
                ...
                "Color Therapy: Planetary frequency healing",
                "Fasting Protocols: Energy field purification"
            ],
            unlocks: [
                "Planetary harmonization",
                "Karmic debugging",
                "Life optimization mastery",
            ...
            <div class="sub-card-inner">
                ...
                <div class="sub-card-content">
                    ...
                    <div class="sub-card-footer">
                        ...
                        <button class="dive-deeper-button" onclick="window.location.href='remedial-technologies.html'">
                            <span class="button-icon">🛠️</span>
                            <span class="button-text">ENTER REPAIR PORTAL</span>
...
window.RemedialTechnologiesCard = RemedialTechnologiesCard;

// Export for module use
if (typeof module !== 'undefined' && module.exports) {
    module.exports = RemedialTechnologiesCard;
}