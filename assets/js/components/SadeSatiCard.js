/**
 * 🪐 Sade Sati Card - Saturn's Great Teacher Period
 * 
 * A clean card component for Sade Sati subcategory.
 * Covers Saturn's 7.5-year transit through the Moon sign and adjacent houses.
 */
...
class SadeSatiCard {
    constructor() {
        this.subCategory = {
            id: "sade-sati",
            title: "Sade Sati",
            subtitle: "Saturn's Great Teacher Period",
            description: "🪐 MASTER SATURN'S GREATEST LESSON CYCLE: Decode the 7.5-year period when Saturn transits the 12th, 1st, and 2nd houses from your Moon sign. Transform life's greatest challenges into spiritual gold through understanding Saturn's systematic restructuring of consciousness and reality.",
            icon: "🪐",
            emoji: "⚖️",
            gradient: "linear-gradient(135deg, #2c3e50 0%, #34495e 50%, #5d6d7e 100%)",
            primaryColor: "#2c3e50",
            secondaryColor: "#5d6d7e",
            cardStyle: "saturn-teacher",
            contentCount: "7 phase mastery modules",
            difficulty: "Intermediate → Advanced",
            timeToMaster: "3-4 months deep study",
            practicalApplications: [
                "Sade Sati phase identification",
                "Challenge period navigation",
                "Karmic lesson extraction",
                "Structural life changes",
                "Spiritual growth acceleration",
                "Reality restructuring mastery"
            ],
            keyTopics: [
                "Phase 1: Rising Sade Sati (12th from Moon)",
                "Phase 2: Peak Sade Sati (1st from Moon)", 
                "Phase 3: Setting Sade Sati (2nd from Moon)",
                "Saturn Return vs Sade Sati Differences",
                "Moon Sign Specific Effects & Remedies",
                "Sade Sati Intensity Calculation Methods",
                "Benefic Saturn: When Sade Sati Brings Gifts",
                "Life Restructuring & Spiritual Evolution"
            ],
            unlocks: [
                "Saturn period mastery",
                "Challenge transformation skills",
                "Karmic pattern understanding",
            ...
            <div class="sub-card-inner">
                ...
                <div class="sub-card-content">
                    ...
                    <div class="sub-card-footer">
                        ...
                        <button class="dive-deeper-button" onclick="window.location.href='sade-sati.html'">
                            <span class="button-icon">🪐</span>
                            <span class="button-text">ENTER SATURN PORTAL</span>
...
window.SadeSatiCard = SadeSatiCard;