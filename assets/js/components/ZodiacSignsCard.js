/**
 * ♈ Zodiac Signs Card - Cosmic Personality Architecture
 * 
 * A clean card component for Zodiac Signs Mastery subcategory.
 * Covers all 12 zodiac signs and elemental mastery systems.
 */

class ZodiacSignsCard {
    constructor() {
        this.subCategory = {
            id: "zodiac-signs",
            ...
            unlocks: [
                "Complete personality mastery",
                "Relationship optimization",
                "Elemental balance mastery",
            ...
            <div class="sub-card-inner">
                ...
                <div class="sub-card-content">
                    ...
                    <div class="sub-card-footer">
                        ...
                        <button class="dive-deeper-button" onclick="window.location.href='./zodiac/zodiac-signs.html'">
...
window.ZodiacSignsCard = ZodiacSignsCard;

// Export for module use
if (typeof module !== 'undefined' && module.exports) {
    module.exports = ZodiacSignsCard;
}